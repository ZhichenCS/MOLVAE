...
def property_prediction(train, val, test):
    ...
    # process and save the one-hot data
    # data = Dataset()
    # if not os.path.exists(data.train):
    #     data.data_pipeline()
    # todo load processed data and get repr
    # train_data, val_data, test_data = data.load_data()
    # train_y, val_y, test_y = data.load_label()
    ...
    for t in range(epoches):
        ...
        print('Epoch {} complete. ---train loss: {}, ---val_loss:{}, ---test_loss: {}'.format(train_loss, val_loss, test_loss))
